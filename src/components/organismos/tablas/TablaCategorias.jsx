...
export function TablaCategorias({
  ...
  function eliminar(p) {
    if (p.nombre === "General") {
      toast.error(  "Este registro no se permite eliminar ya que es valor por defecto.");
      return;
    }
    Swal.fire({
  ...
  function editar(data) {
    if (data.nombre === "General") {
      toast.error(  "Este registro no se permite modificar ya que es valor por defecto.");
      return;
    }
